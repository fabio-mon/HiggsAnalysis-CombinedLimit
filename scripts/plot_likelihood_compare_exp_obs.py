...
if options.infilename_obs != "" and options.infilename_exp != "":
    ...
    contour68_obs.SetLineColor(r.kOrange+7)
    contour68_obs.SetLineStyle(1)
    contour95_obs.SetLineColor(r.kOrange+7)
    contour95_obs.SetLineStyle(3)
    Bestfit_obs.SetMarkerColor(r.kOrange+7)
    Bestfit_obs.SetMarkerStyle(20)
    ...
    legend_2D.AddEntry(Bestfit_obs,"Best fit obs.","P")
    legend_2D.AddEntry(contour68_obs,"obs. 68%C.L.","L")
    legend_2D.AddEntry(contour95_obs,"obs. 95%C.L.","L")
    legend_2D.AddEntry(Bestfit_exp,"Best fit exp.","P")
    legend_2D.AddEntry(contour68_exp,"exp. 68%C.L.","L")
    legend_2D.AddEntry(contour95_exp,"exp. 95%C.L.","L")
    #legend_2D.AddEntry(contour68_obs,"HH categories 68%C.L.","L")
    #legend_2D.AddEntry(contour95_obs,"HH categories 95%C.L.","L")
    #legend_2D.AddEntry(contour68_exp,"HH+t#bar{t}H categories 68%C.L.","L")
    #legend_2D.AddEntry(contour95_exp,"HH+t#bar{t}H categories 95%C.L.","L")
    #legend_2D.AddEntry(contour68_obs,"NLO HH sample 68%C.L.","L")
    #legend_2D.AddEntry(contour95_obs,"NLO HH sample 95%C.L.","L")
    #legend_2D.AddEntry(contour68_exp,"LO HH sample 68%C.L.","L")
    #legend_2D.AddEntry(contour95_exp,"LO HH sample 95%C.L.","L")
    #legend_2D.AddEntry(contour68_obs,"w/ BR_{bb} scaling 68%C.L.","L")
    #legend_2D.AddEntry(contour95_obs,"w/ BR_{bb} scaling 95%C.L.","L")
    #legend_2D.AddEntry(contour68_exp,"w/o BR_{bb} scaling 68%C.L.","L")
    #legend_2D.AddEntry(contour95_exp,"w/o BR_{bb} scaling 95%C.L.","L")
    #legend_2D.AddEntry(contour68_obs,"Inexact btag SF norm. 68%C.L.","L")
    #legend_2D.AddEntry(contour95_obs,"Inexact btag SF norm. 95%C.L.","L")
    #legend_2D.AddEntry(contour68_exp,"Correct btag SF norm. 68%C.L.","L")
    #legend_2D.AddEntry(contour95_exp,"Correct btag SF norm. 95%C.L.","L")
    ...
    klscan_obs.SetLineColor(r.kOrange+7)
    ...
    #legend_1D.AddEntry(klscan_obs,"HH categories","L")
    #legend_1D.AddEntry(klscan_exp,"HH+t#bar{t}H categories","L")
    ...
    ktscan_obs.SetLineColor(r.kOrange+7)    
