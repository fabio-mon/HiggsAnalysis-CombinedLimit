...
class HHModel(PhysicsModel):
    ...
    def __init__(self, ggf_sample_list, vbf_sample_list, name, force_BR1="", force_BR2=""):
        ...
        self.force_BR1 = force_BR1
        self.force_BR2 = force_BR2
    ...
    def getYieldScale(self,bin,process):
        ...
        decaySource = []
        if self.force_BR1!="":
            decaySource.append(self.force_BR1)
        else:
        ...
        if processSource == "ggHH" or processSource == "qqHH":
            if self.force_BR2!="":
                decaySource.append(self.force_BR2)
            else:
